          ...
          response.on("end", () => {
            ...
            StockData.findOneAndUpdate(
              ...
              (err, result1) => {
                ...
                ComparisonData.findOneAndUpdate(
                  { stocks: stock },
                  {
                    $set: {
                      stocks: stock,
                      ...
                      stockData: [
                        {
                          ...
                          rel_likes:
                            doc.stockData[0][0].likes -
                            doc.stockData[0][1].likes,
                        },
                        {
